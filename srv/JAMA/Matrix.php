...
*/
  ...
  */
  ...
  function getHTML($width=2) {
    $s = '';
    $s .= '<table style="background-color:#eee;">';
    for( $i = 0; $i < $this->m; $i++ ) {
      $s .= '<tr>';
      for( $j = 0; $j < $this->n; $j++ )
        $s .= '<td style="background-color:#fff;border:1px solid #000;padding:2px;text-align:center;vertical-align:middle;">' . $this->A[$i][$j] . '</td>';
      $s .= '</tr>';
    }
    $s .= '</table>';
